  ...
  <div class="mazda-card">
    ...
    <form method='post' action='/actualizar-siniestro'>
      <div class="form-group">
        ...
        <small id="carga-mensaje" style="color:#6b6b8a;display:block;margin-top:.35rem;">Escribe el número y pulsa Cargar para traer lo que ya existe en Supabase.</small>
      </div>
      <div class="form-row">
        <div class="form-group">
    ...
    async function cargarSiniestro(){
      ...
      try{
        ...
        msg.textContent='✓ Datos cargados desde Supabase. Puedes modificarlos y guardar.'; msg.style.color='#188038';
      }catch(e){ msg.textContent='No fue posible consultar Supabase.'; msg.style.color='#c0392b'; }
    }
